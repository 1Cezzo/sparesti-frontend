<template>
  <div id="generateChallengeContainer">
    <div id="generateChallengeContent">
      <div class="challengeBox">
        ...
        <div class="emojiContainer">
          ...
          <p class="emoji">{{ challengeObject.mediaUrl }}</p>
        </div>
        ...
        <template v-slot:icon>
          ...
          >
            <path
              ...
              stroke="var(--color-button-challenges-back)"
              stroke-width="1.5"
        ...
        <template v-slot:icon>
          ...
          >
            <path
              ...
              fill="var(--color-button-challenges-back)"
            />
            <path
...
.challengeBox {
  ...
  border: 0.5vw solid var(--color-badges-owned);
  border-radius: 20px;
  padding: 1rem 0;
  width: 250px;
  flex-shrink: 0;
...
.headerDiv {
  ...
  border: 2 px solid var(--color-badges-owned);
  border-radius: 40px;
  padding: 0 0.5rem;
